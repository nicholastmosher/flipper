...
extern {
    ...
    fn lf_append_arg(argv: *mut *mut c_void, value: u64, kind: u8) -> u32;
...
unsafe fn led_rgb(flipper: *mut c_void, red: u8, green: u8, blue: u8) {
    ...
    let argv_handle = &mut argv as *mut *mut c_void;
    lf_append_arg(argv_handle, red as u64, 0);
    lf_append_arg(argv_handle, green as u64, 0);
    lf_append_arg(argv_handle, blue as u64, 0);
